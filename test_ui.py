...
def run_automated_test():
    with sync_playwright() as p:
        ...
        # Access the locally running Streamlit address
        page.goto("http://localhost:8501")

        # 1. 测试提问功能
        # 1. Test Question Function
        ...
        # 等待双栏响应出现，超时时间设为 30秒
        # Wait for the dual-column response to appear, with a timeout set to 30 seconds
        time.sleep(20)

        # 2. 验证页面是否显示了预期的双栏标题
        # 2. Verify whether the page displays the expected two-column title
